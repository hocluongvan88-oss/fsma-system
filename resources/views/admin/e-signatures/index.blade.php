...
@section('title', __('messages.e_signature_performance_dashboard'))
...
<div style="padding: 0;">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem; padding-bottom: 1rem; border-bottom: 1px solid var(--border-color);">
        <div style="display: flex; gap: 0.75rem;">
            ...
            <select id="periodFilter" class="form-select" onchange="filterByPeriod(this.value)" style="width: auto; padding: 0.625rem 1rem;">
                <option value="day">{{ __('messages.today') }}</option>
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 1rem; margin-bottom: 2rem;">
        ...
        <div class="card" style="border-left: 4px solid var(--accent-primary); padding: 1.5rem;">
            <p style="color: var(--text-secondary); font-size: 0.875rem; margin: 0 0 0.75rem 0; font-weight: 500;">{{ __('messages.total_signatures') }}</p>
        ...
        <div class="card" style="border-left: 4px solid var(--success); padding: 1.5rem;">
            <p style="color: var(--text-secondary); font-size: 0.875rem; margin: 0 0 0.75rem 0; font-weight: 500;">{{ __('messages.success_rate') }}</p>
        ...
        <div class="card" style="border-left: 4px solid var(--warning); padding: 1.5rem;">
            <p style="color: var(--text-secondary); font-size: 0.875rem; margin: 0 0 0.75rem 0; font-weight: 500;">{{ __('messages.avg_creation_time') }}</p>
        ...
        <div class="card" style="border-left: 4px solid #8b5cf6; padding: 1.5rem;">
            <p style="color: var(--text-secondary); font-size: 0.875rem; margin: 0 0 0.75rem 0; font-weight: 500;">{{ __('messages.avg_verification_time') }}</p>
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(400px, 1fr)); gap: 1.5rem; margin-bottom: 2rem;">
        <!-- Performance Chart -->
        <div class="card">
            <h3 style="font-size: 1rem; font-weight: 600; margin: 0 0 1.5rem 0;">{{ __('messages.performance_trend') }}</h3>
            <canvas id="performanceChart" style="max-height: 300px;"></canvas>
        </div>

        <!-- Status Distribution -->
        <div class="card">
            <h3 style="font-size: 1rem; font-weight: 600; margin: 0 0 1.5rem 0;">{{ __('messages.status_distribution') }}</h3>
    ...
    <div class="card">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem;">
            <h3 style="font-size: 1rem; font-weight: 600; margin: 0;">{{ __('messages.recent_signatures_last_10') }}</h3>
            <a href="{{ route('admin.e-signatures.index') }}" class="btn btn-secondary" style="font-size: 0.875rem; padding: 0.5rem 1rem;">{{ __('messages.view_all') }}</a>
        </div>
        ...
        <div class="table-container">
            <table>
                ...
                <tbody id="recentSignaturesTable">
                    <tr>
                        <td colspan="7" style="text-align: center; color: var(--text-muted); padding: 2rem;">{{ __('messages.loading') }}</td>
                    </tr>
                </tbody>
            </table>
        </div>
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1.5rem; margin-top: 2rem;">
        <!-- Bottleneck Analysis -->
        <div class="card">
            <h3 style="font-size: 1rem; font-weight: 600; margin: 0 0 1.5rem 0;">{{ __('messages.bottleneck_analysis') }}</h3>
            <div id="bottleneckAnalysis" style="space-y: 1rem;">
                <p style="color: var(--text-muted);">{{ __('messages.loading') }}</p>
            </div>
        </div>

        <!-- Error Summary -->
        <div class="card">
            <h3 style="font-size: 1rem; font-weight: 600; margin: 0 0 1.5rem 0;">{{ __('messages.error_summary') }}</h3>
